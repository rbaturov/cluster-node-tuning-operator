...
func CalculateUpdatedStatus(ctx context.Context, prevStatus *performancev2.PerformanceProfileStatus, profileName string, conditions []conditionsv1.Condition) *performancev2.PerformanceProfileStatus {
