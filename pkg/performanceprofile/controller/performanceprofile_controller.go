...
const (
	...
	ControllerGeneratedMachineConfig      = "hypershift.openshift.io/nto-generated-machine-config"
	ControllerGeneratedTunedConfig        = "hypershift.openshift.io/tuned-config"
)
...
func (r *PerformanceProfileReconciler) SetupWithManagerForHypershift(mgr ctrl.Manager, managementCluster cluster.Cluster) error {
	...
	performanceProfileConfigMapPredicate := predicate.Funcs{
		UpdateFunc: func(ue event.UpdateEvent) bool {
			...
			return validateLabels(ue.ObjectNew, ControllerGeneratedPerformanceProfile, "UpdateEvent")
		},
		CreateFunc: func(ce event.CreateEvent) bool {
			...
			return validateLabels(ce.Object, ControllerGeneratedPerformanceProfile, "CreateEvent")
		},
		DeleteFunc: func(de event.DeleteEvent) bool {
			...
			return validateLabels(de.Object, ControllerGeneratedPerformanceProfile, "DeleteEvent")
		},
	}
